...
## Lilia and Tabea
## Enemy Movement, AI Logic, Properties and SFX.
## 
...
var explosion_scene := preload("res://scenes/game/levels/animations/explosion.tscn")
var item_scene := preload("res://scenes/game/entity/items/item.tscn")
